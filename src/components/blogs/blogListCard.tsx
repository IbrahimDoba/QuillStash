...
const BloglistCard: React.FC<BloglistCardProps> = ({ posts, loading, error }) => {
  ...
  return (
    <div className="max-w-[720px] mx-auto bg-transparent rounded-xl shadow-md overflow-hidden">
      {currentPosts.map(post => (
        <div key={post._id} className="md:flex bg-white p-4 flex my-8 border items-center justify-around border-gray-300 rounded-lg shadow-lg">
