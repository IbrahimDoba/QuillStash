import {
  ...
  const LikeContentCard = ({
    ...
    const unlikePost = async () => {
        ...
        try {
          const response = await fetch(`/api/like?postId=${postId}&userId=${session.user.id}`, {
            method: 'DELETE',
          });
          ...
          if (response.ok) {
            ...
            toast.error(data.message || 'Failed to unlike the post');
          }
        } catch (error) {
  ...
  export default LikeContentCard;